...
set group [Node allocaddr] ;#allocate multicast address 
#===================================
#        Nodes Definition        
#===================================
#Create 5 nodes
...
set mrthandle [$ns mrtproto $mproto] ; #all node will contain multicast agents
...
$ns at 1.15 "$n3 join-group $rcvr2 $group" ;
